...
top_srcdir = .
BUILD_DIR = /home/amin/projects/readline/readline-8.2

INSTALL = /usr/bin/install -c
INSTALL_PROGRAM = ${INSTALL}
INSTALL_DATA = ${INSTALL} -m 644

CC = /home/amin/apps/wasi-sdk/bin/clang
RANLIB = /home/amin/apps/wasi-sdk/bin/ranlib
AR = /home/amin/apps/wasi-sdk/bin/ar
ARFLAGS = cr
RM = rm -f
CP = cp
MV = mv
...
GCC_LINT_CFLAGS = $(XCCFLAGS) $(GCC_LINT_FLAGS) --sysroot=/home/amin/projects/wasix-libc/sysroot32/ --target=wasm32-wasi -matomics -mbulk-memory -mmutable-globals -pthread -mthread-model posix -ftls-model=local-exec -fno-trapping-math -D_WASI_EMULATED_MMAN -D_WASI_EMULATED_SIGNAL -D_WASI_EMULATED_PROCESS_CLOCKS -DUSE_TIMEGM -DOPENSSL_NO_SECURE_MEMORY -DOPENSSL_NO_DGRAM -DOPENSSL_THREADS -O3 -g -flto  
